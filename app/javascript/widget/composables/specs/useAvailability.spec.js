...
describe('useAvailability', () => {
  const originalWindow = window.saturnWebChannel;
  ...
  afterEach(() => {
    window.saturnWebChannel = originalWindow;
  });
  ...
  describe('config changes', () => {
    it('should react to window.saturnWebChannel changes', () => {

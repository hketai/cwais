class CreateSaturnCustomTools < ActiveRecord::Migration[7.1]
  def change
    create_table :saturn_custom_tools do |t|
    ...
    add_index :saturn_custom_tools, [:account_id, :slug], unique: true
  end
end
